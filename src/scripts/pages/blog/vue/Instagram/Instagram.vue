    ...
    <div class="blog-insta__header">
      <div class="blog-insta__title">
        <h2 class="visually-hidden">
          Жизнь <i class="red">w</i>eb-<i class="red">a</i>lt
        </h2>
        <svg
          viewBox="0 0 282 27"
          fill-rule="evenodd"
      ...
      <span class="blog-insta__describe"
        >Атмосфера, рабочие будни, путешествия, прямые включения и советы для
        вашего бизнеса тут:</span
      >
      <a
        href="https://www.instagram.com/web_alternative/"
        class="blog-insta__link"
        target="_blank"
        rel="noopener noreferrer"
        ><span class="icon"></span>@web_alternative</a
      >
    </div>
