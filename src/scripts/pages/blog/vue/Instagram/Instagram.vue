<template>
  <article ref="insta" class="blog-insta">
    <div class="blog-insta__header">
      <div class="blog-insta__title">
        <h2 class="visually-hidden">Жизнь <i class="red">w</i>eb-<i
          class="red">a</i>lt</h2>
        <svg viewBox="0 0 282 27" fill-rule="evenodd" clip-rule="evenodd"
      ...
      <a href="https://www.instagram.com/web_alternative/"
         class="blog-insta__link" target="_blank"
...
.blog-insta__link:hover .icon {
  background-image: url("../../../../../../public/images/i-instagram--orange.svg");
}
</style>
