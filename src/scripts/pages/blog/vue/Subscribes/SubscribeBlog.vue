  ...
  <div class="subscribe-block  relative w-full h-full bg-sun">
    <div class="grid content-center w-full h-full">
      <div
        ...
        <form class="subscribe-block__form  col-start-2 col-span-3 grid gap-7"
              action="/subscribe"
              novalidate>
          <h2
            class="title-size  font-semibold text-black">
            Подпишитесь
            на нашу рассылку</h2>
          <span class="text-size  mb-6">Получи доступ к нашей видео базе знаний с семинаров!</span>
          <div class="grid grid-cols-fillAuto  gap-4 items-start pr-9">
            <div class="form-field grid gap-2">
              <label class="sr-only" for="subscribe-email-block">Электронная
                почта</label>
              <input
                ...
                type="email" name="email" id="subscribe-email-block"
        ...
        <div class="subscribe-block__icon  relative  row-start-2 col-start-4">
          <div class="absolute w-208px h-208px">
    ...
    <div
      class="text-120 absolute bottom-0 grid text-true-black font-medium uppercase opacity-5">
...
.subscribe-block__image {
  width: vw(154) !important;
  height: vw(190) !important;
}
